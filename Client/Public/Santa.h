...
public:
	explicit CSanta::CSanta(LPDIRECT3DDEVICE9 _pDevice);

	explicit CSanta::CSanta(LPDIRECT3DDEVICE9 _pDevice, ST_GAMEOBJECT_FILE_INFO& tFileInfo);

	explicit CSanta::CSanta(const CSanta& _rhs);
...
public:
	static CGameObject* CSanta::Create(LPDIRECT3DDEVICE9 _pDevice, ST_GAMEOBJECT_FILE_INFO& stFileInfo);
