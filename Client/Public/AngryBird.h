...
BEGIN(Client)
class CAngryBird : public CMonster
{
public :
	enum ANI_CUBE {
...
public:
	explicit CAngryBird::CAngryBird(LPDIRECT3DDEVICE9 _pDevice);

	explicit CAngryBird::CAngryBird(LPDIRECT3DDEVICE9 _pDevice, ST_GAMEOBJECT_FILE_INFO& tFileInfo);

	explicit CAngryBird::CAngryBird(const CAngryBird& _rhs);

	virtual ~CAngryBird() = default;
public:
...
public:
	static CGameObject* CAngryBird::Create(LPDIRECT3DDEVICE9 _pDevice, ST_GAMEOBJECT_FILE_INFO& stFileInfo);
