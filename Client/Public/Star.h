...
BEGIN(Client)
class CStar final : public CMonster
{
public:
...
private:
	explicit CStar(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CStar(const CStar& rhs);
...
public:
	static CStar* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
