...
CStar::CStar(LPDIRECT3DDEVICE9 pGraphic_Device)
...
HRESULT CStar::NativeConstruct_Prototype()
{
...
HRESULT CStar::NativeConstruct(void* pArg)
{
...
HRESULT CStar::SetUp_Components()
{
	/* For.Com_Transform */
...
HRESULT CStar::SetUp_RenderState()
{
...
HRESULT CStar::Release_RenderState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
CStar * CStar::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CStar*	pInstance = new CStar(pGraphic_Device);
