...
CUI_BackGround::CUI_BackGround(LPDIRECT3DDEVICE9 _GraphicDevice)
...
HRESULT CUI_BackGround::SetUp_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Components(LEVEL_LOGO, TEXT("Prototype_Component_Texture_UI_BackGround"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
HRESULT CUI_BackGround::SetUp_RenderState()
{
...
HRESULT CUI_BackGround::Release_RenderState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
CUI_BackGround * CUI_BackGround::Create(LPDIRECT3DDEVICE9 _GraphicDevice)
{
	CUI_BackGround* pInstance = new CUI_BackGround(_GraphicDevice);
	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX(TEXT("Error : Failed Created UI_BackGround Prototype"));
...
CGameObject * CUI_BackGround::Clone(void * pArg)
{
	...
	{
		MSGBOX(TEXT("Error : Failed Cloned UI_BackGround Copy"));
		Safe_Release(pInstance);
	}
	return pInstance;
}
