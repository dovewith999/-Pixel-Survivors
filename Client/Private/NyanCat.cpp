#include "stdafx.h"
#include "..\Public\NyanCat.h"
#include "GameInstance.h"

#include "Player.h"
#include "../Public/MyTerrain.h"

CNyanCat::CNyanCat(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CMonster(pGraphic_Device)
{

}

CNyanCat::CNyanCat(const CNyanCat & rhs)
	: CMonster(rhs)
{

}

HRESULT CNyanCat::NativeConstruct_Prototype()
{
...
HRESULT CNyanCat::NativeConstruct(void* pArg)
{
	...
	pMasterCube->Set_CubeSize(D3DXVECTOR3(2.f, 1.f, 1.f));
...
void CNyanCat::Tick(_float fTimeDelta)
{
...
void CNyanCat::Late_Tick(_float fTimeDelta)
{
...
HRESULT CNyanCat::SetUp_Components()
{
	/* For.Com_Transform */
...
HRESULT CNyanCat::SetUp_RenderState()
{
...
HRESULT CNyanCat::Release_RenderState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
CNyanCat * CNyanCat::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CNyanCat*	pInstance = new CNyanCat(pGraphic_Device);
...
CGameObject * CNyanCat::Clone(void * pArg)
{
	CNyanCat*	pInstance = new CNyanCat(*this);
