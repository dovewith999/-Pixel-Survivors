#include "stdafx.h"
#include "..\Public\Curvy.h"
#include "GameInstance.h"

#include "Player.h"
#include "../Public/MyTerrain.h" // CH 추가
#include "Gun.h"

CCurvy::CCurvy(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CMonster(pGraphic_Device)
{

}

CCurvy::CCurvy(const CCurvy & rhs)
	: CMonster(rhs)
{

}

HRESULT CCurvy::NativeConstruct_Prototype()
{
...
HRESULT CCurvy::NativeConstruct(void* pArg)
{
	...
	//몸체 큐브 생성
	TCHAR* strPath = L"../../Data/Curvy.dat";
	...
	pMasterCube->Set_CubeSize(D3DXVECTOR3(1.f, 1.f, 1.f));
...
void CCurvy::Tick(_float fTimeDelta)
{
...
void CCurvy::Late_Tick(_float fTimeDelta)
{
...
HRESULT CCurvy::SetUp_Components()
{
	/* For.Com_Transform */
	...
	BattleData.iAtk = 4;
	BattleData.iDeffence = 1;
	BattleData.iMaxHP = 40;
	BattleData.iHP = 40;
...
HRESULT CCurvy::SetUp_RenderState()
{
...
HRESULT CCurvy::Release_RenderState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
CCurvy * CCurvy::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CCurvy*	pInstance = new CCurvy(pGraphic_Device);
...
CGameObject * CCurvy::Clone(void * pArg)
{
	CCurvy*	pInstance = new CCurvy(*this);
